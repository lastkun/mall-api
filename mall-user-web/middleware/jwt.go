...
// 解析 token
func (j *JWT) ParseToken(tokenString string) (*utils.CustomClaims, error) {
	token, err := jwt.ParseWithClaims(tokenString, &utils.CustomClaims{}, func(token *jwt.Token) (i interface{}, e error) {
